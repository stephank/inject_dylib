...
const char *indy_couldnt_allocate_mach_port =
    "Couldn't allocate mach port (mach_port_allocate error %d)\n";

const char *indy_couldnt_extract_port_receive_right =
    "Couldn't extract port receive right (mach_port_extract_right error %d)\n";

const char *indy_couldnt_insert_port_send_right =
    "Couldn't insert port send right (mach_port_insert_right error %d)\n";
